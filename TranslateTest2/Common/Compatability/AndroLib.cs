...
namespace TranslateTest2.Common.Compatability
{
    public static class AndroLib
    {
        ...
        // Reflection cache for UI manager
        ...
        [JITWhenModsEnabled(new string[]{"androLib"})]
        public static bool NoBagsHovered
        {
            get
            {
        ...
        [JITWhenModsEnabled(new string[]{"androLib"})]
        public static void UpdateBagSlotCache() { if (!Enabled) return; AndroLibReference.UpdateItemSlot(); }
    }
}
