...
namespace TranslateTest2.Items.Tools
{
    ...
    private static readonly WarpMode[] CycleModes = new[] { WarpMode.Spawn, WarpMode.Bed, WarpMode.Ocean, WarpMode.Hell, WarpMode.Death, WarpMode.Random };
        ...
        // スプライト差し替え（7枚）
        public override string Texture => "TranslateTest2/Items/Tools/AiPhone_Dummy";

        // パスヘルパ
        private static string TexPath(string name) => $"TranslateTest2/Items/Tools/{name}";
