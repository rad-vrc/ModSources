...
// Type: QoLCompendium.Core.QoLCConfig
...
public class QoLCConfig : ModConfig
{
  ...
  public HashSet<string> VeinMinerTileWhitelist = new HashSet<string>()
  {
    ...
    "Terraria:" + TileID.Search.GetName(63 /*0x3F*/),
    "Terraria:" + TileID.Search.GetName(64 /*0x40*/),
    ...
    "Terraria:" + TileID.Search.GetName(224 /*0xE0*/),
    ...
    "Terraria:" + TileID.Search.GetName(48 /*0x30*/)
  };
  ...
  public virtual void OnLoaded() => QoLCompendium.QoLCompendium.mainConfig = this;
  ...
  public class MainClientConfig : ModConfig
  {
    ...
    public virtual void OnLoaded() => QoLCompendium.QoLCompendium.mainClientConfig = this;
  ...
  public class ItemConfig : ModConfig
  {
    ...
    public virtual void OnLoaded() => QoLCompendium.QoLCompendium.itemConfig = this;
  ...
  public class ShopConfig : ModConfig
  {
    ...
    public virtual void OnLoaded() => QoLCompendium.QoLCompendium.shopConfig = this;
  ...
  public class TooltipConfig : ModConfig
  {
    ...
    public virtual void OnLoaded() => QoLCompendium.QoLCompendium.tooltipConfig = this;
  }
}
