...
// Type: QoLCompendium.Core.Changes.ItemChanges.ItemTransmutation
...
public class ItemTransmutation : GlobalItem
{
  ...
  {
    if (QoLCompendium.QoLCompendium.mainConfig.BossItemTransmutation)
    {
      Common.TransmuteItems(new int[3]
      {
        256 /*0x0100*/,
        257,
        258
      });
      Common.TransmuteItems(new int[3]{ 1123, 2888, 1121 });
      Common.TransmuteItems(new int[3]{ 842, 843, 844 });
      Common.TransmuteItems(new int[4]
      {
        5095,
        5117,
        5118,
      ...
      Common.TransmuteItems(new int[3]{ 4982, 4983, 4984 });
      Common.TransmuteItems(new int[7]
      {
        3018,
        1259,
        758,
      ...
      Common.TransmuteItems(new int[5]
      {
        2611,
        2624,
        2622,
      ...
      Common.TransmuteItems(new int[9]
      {
        3389,
        3063,
        3065,
      ...
      Common.TransmuteItems(new int[8]
      {
        1782,
        1784,
        1811,
      ...
      Common.TransmuteItems(new int[2]{ 1910, 1929 });
      Common.TransmuteItems(new int[4]
      {
        1947,
        1946,
      ...
      Common.TransmuteItems(new int[6]
      {
        2880,
        2797,
        2796,
      ...
      Common.TransmuteItems(new int[2]{ 4381, 4273 });
      Common.TransmuteItems(new int[2]{ 4270, 4272 });
      Common.TransmuteItems(new int[3]{ 3054, 3052, 3053 });
      Common.TransmuteItems(new int[2]{ 1571, 1569 });
      Common.TransmuteItems(new int[5]
      {
        3008,
        3014,
      ...
      Common.TransmuteItems(new int[2]{ 3290, 3282 });
      Common.TransmuteItems(new int[3]{ 3187, 3188, 3189 });
      Common.TransmuteItems(new int[4]
      {
      ...
      Common.TransmuteItems(new int[2]
      {
    ...
    if (!QoLCompendium.QoLCompendium.mainConfig.ItemConversions)
      return;
    Common.TransmuteItems(new int[4]
    {
      2214,
    ...
    Common.TransmuteItems(new int[2]{ 407, 1923 });
    Common.TransmuteItems(new int[3]{ 3031, 4820, 5302 });
    Common.TransmuteItems(new int[3]{ 3032, 4872, 5303 });
  }
}
