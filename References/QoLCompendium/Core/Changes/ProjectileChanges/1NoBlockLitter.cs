...
// Type: QoLCompendium.Core.Changes.ProjectileChanges.NoSnowLitter
...
public class NoSnowLitter : GlobalProjectile
{
  ...
  {
    if (!QoLCompendium.QoLCompendium.mainConfig.NoLittering || projectile.owner != Main.myPlayer)
      return;
    int index = Item.NewItem(((Entity) projectile).GetSource_DropAsItem((string) null), ((Entity) projectile).Hitbox, 593, 1, false, 0, false, false);
