...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.Vanilla.Potions.PlentySatisfiedEffect
...
public class PlentySatisfiedEffect : IPermanentBuff
{
  internal override void ApplyEffect(PermanentBuffPlayer player)
  {
    ...
    player1.statDefense = Player.DefenseStat.op_Addition(player1.statDefense, 3);
    ...
    local1 = StatModifier.op_Addition(local1, 0.075f);
    ref StatModifier local2 = ref player.Player.GetKnockback(DamageClass.Summon);
    local2 = StatModifier.op_Addition(local2, 0.75f);
