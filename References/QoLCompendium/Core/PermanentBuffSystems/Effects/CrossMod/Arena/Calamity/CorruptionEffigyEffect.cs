...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Arena.Calamity.CorruptionEffigyEffect
...
public class CorruptionEffigyEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "CorruptionEffigyBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[1])
      return;
