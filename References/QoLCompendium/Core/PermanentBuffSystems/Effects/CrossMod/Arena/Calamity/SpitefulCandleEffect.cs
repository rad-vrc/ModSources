...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Arena.Calamity.SpitefulCandleEffect
...
public class SpitefulCandleEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "YellowCandleBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[5])
      return;
