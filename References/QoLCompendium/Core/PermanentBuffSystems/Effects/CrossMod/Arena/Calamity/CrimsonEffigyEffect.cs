...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Arena.Calamity.CrimsonEffigyEffect
...
public class CrimsonEffigyEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "CrimsonEffigyBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[2])
      return;
