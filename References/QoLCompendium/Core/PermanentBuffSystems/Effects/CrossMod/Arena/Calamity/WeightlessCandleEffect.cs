...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Arena.Calamity.WeightlessCandleEffect
...
public class WeightlessCandleEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "BlueCandleBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[8])
      return;
