...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Arena.Calamity.EffigyOfDecayEffect
...
public class EffigyOfDecayEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "EffigyOfDecayBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[3])
      return;
