...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Arena.Calamity.ResilientCandleEffect
...
public class ResilientCandleEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "PurpleCandleBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[4])
      return;
