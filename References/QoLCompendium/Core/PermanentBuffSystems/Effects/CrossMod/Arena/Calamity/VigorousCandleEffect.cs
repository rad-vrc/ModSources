...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Arena.Calamity.VigorousCandleEffect
...
public class VigorousCandleEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "PinkCandleBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[7])
      return;
