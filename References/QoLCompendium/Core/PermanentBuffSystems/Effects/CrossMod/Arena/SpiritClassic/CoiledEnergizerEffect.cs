...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Arena.SpiritClassic.CoiledEnergizerEffect
...
public class CoiledEnergizerEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "OverDrive")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[0])
      return;
