...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Arena.SpiritClassic.SunPotEffect
...
public class SunPotEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "SunPotBuff")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[2])
      return;
