...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Arena.CalamityEntropy.VoidCandleEffect
...
public class VoidCandleEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityEntropyLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityEntropyMod, "VoidCandleBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[30])
      return;
