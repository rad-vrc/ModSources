...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Flasks.Thorium.ThrownWeaponImbueDeepFreezeEffect
...
public class ThrownWeaponImbueDeepFreezeEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "DeepFreezeCoatingBuff")])
      return;
