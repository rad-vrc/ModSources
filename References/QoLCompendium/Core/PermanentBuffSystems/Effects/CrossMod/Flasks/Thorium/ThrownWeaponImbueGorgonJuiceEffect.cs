...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Flasks.Thorium.ThrownWeaponImbueGorgonJuiceEffect
...
public class ThrownWeaponImbueGorgonJuiceEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "GorgonCoatingBuff")])
      return;
