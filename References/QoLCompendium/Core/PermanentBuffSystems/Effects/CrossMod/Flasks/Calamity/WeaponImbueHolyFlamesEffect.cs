...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Flasks.Calamity.WeaponImbueHolyFlamesEffect
...
public class WeaponImbueHolyFlamesEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "WeaponImbueHolyFlames")])
      return;
