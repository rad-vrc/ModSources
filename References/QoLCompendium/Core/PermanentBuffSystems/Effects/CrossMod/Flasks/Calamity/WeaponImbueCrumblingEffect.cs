...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Flasks.Calamity.WeaponImbueCrumblingEffect
...
public class WeaponImbueCrumblingEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "WeaponImbueCrumbling")])
      return;
