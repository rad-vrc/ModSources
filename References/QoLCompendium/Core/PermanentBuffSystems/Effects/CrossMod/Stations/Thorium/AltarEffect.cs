...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Stations.Thorium.AltarEffect
...
public class AltarEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "AltarBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[23])
      return;
