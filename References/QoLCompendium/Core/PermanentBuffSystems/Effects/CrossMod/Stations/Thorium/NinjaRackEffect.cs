...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Stations.Thorium.NinjaRackEffect
...
public class NinjaRackEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "NinjaBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[25])
      return;
