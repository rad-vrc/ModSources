...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Stations.MartinsOrder.SporeFarmEffect
...
public class SporeFarmEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "SporeSave")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[18])
      return;
