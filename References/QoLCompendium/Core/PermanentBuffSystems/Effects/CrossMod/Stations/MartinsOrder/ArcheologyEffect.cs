...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Stations.MartinsOrder.ArcheologyEffect
...
public class ArcheologyEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "ReschBuff")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[17])
      return;
