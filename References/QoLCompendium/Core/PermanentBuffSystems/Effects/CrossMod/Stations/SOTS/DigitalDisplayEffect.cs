...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Stations.SOTS.DigitalDisplayEffect
...
public class DigitalDisplayEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.secretsOfTheShadowsLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.secretsOfTheShadowsMod, "CyberneticEnhancements")] || PermanentBuffPlayer.PermanentSOTSBuffsBools[10])
      return;
