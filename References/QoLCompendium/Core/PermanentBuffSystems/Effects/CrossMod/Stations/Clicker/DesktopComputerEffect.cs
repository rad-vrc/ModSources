...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Stations.Clicker.DesktopComputerEffect
...
public class DesktopComputerEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.clickerClassLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.clickerClassMod, "DesktopComputerBuff")])
      return;
