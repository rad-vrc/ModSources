...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.PhotosynthesisEffect
...
public class PhotosynthesisEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "PhotosynthesisBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[18])
      return;
