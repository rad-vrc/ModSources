...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.OmniscienceEffect
...
public class OmniscienceEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "Omniscience")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[17])
      return;
