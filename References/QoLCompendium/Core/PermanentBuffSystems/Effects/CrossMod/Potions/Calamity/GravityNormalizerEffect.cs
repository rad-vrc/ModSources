...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.GravityNormalizerEffect
...
public class GravityNormalizerEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "GravityNormalizerBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[16 /*0x10*/])
      return;
