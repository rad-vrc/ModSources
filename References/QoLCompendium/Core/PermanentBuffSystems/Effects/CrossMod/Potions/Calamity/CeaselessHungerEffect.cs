...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.CeaselessHungerEffect
...
public class CeaselessHungerEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "CeaselessHunger")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[15])
      return;
