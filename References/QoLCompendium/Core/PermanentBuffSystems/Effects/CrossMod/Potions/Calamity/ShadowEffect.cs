...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.ShadowEffect
...
public class ShadowEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "ShadowBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[19])
      return;
