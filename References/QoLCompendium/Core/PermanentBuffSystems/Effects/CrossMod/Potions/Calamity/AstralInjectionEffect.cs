...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.AstralInjectionEffect
...
public class AstralInjectionEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "AstralInjectionBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[10])
      return;
