...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.SulphurskinEffect
...
public class SulphurskinEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "SulphurskinBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[21])
      return;
