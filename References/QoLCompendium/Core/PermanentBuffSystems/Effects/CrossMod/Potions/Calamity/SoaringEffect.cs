...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.SoaringEffect
...
public class SoaringEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "Soaring")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[20])
      return;
