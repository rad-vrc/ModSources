...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.AnechoicCoatingEffect
...
public class AnechoicCoatingEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "AnechoicCoatingBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[9])
      return;
