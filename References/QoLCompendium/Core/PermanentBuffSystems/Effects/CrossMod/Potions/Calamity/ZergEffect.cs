...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.ZergEffect
...
public class ZergEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "Zerg")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[24])
      return;
