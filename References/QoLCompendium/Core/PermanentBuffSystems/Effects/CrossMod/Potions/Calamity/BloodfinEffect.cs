...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.BloodfinEffect
...
public class BloodfinEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "BloodfinBoost")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[12])
      return;
