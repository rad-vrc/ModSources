...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Calamity.BaguetteEffect
...
public class BaguetteEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityMod, "BaguetteBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[11])
      return;
