...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SOTS.DoubleVisionEffect
...
public class DoubleVisionEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.secretsOfTheShadowsLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.secretsOfTheShadowsMod, "DoubleVision")] || PermanentBuffPlayer.PermanentSOTSBuffsBools[3])
      return;
