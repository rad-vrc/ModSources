...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SOTS.RoughskinEffect
...
public class RoughskinEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.secretsOfTheShadowsLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.secretsOfTheShadowsMod, "Roughskin")] || PermanentBuffPlayer.PermanentSOTSBuffsBools[7])
      return;
