...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SOTS.VibeEffect
...
public class VibeEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.secretsOfTheShadowsLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.secretsOfTheShadowsMod, "GoodVibes")] || PermanentBuffPlayer.PermanentSOTSBuffsBools[9])
      return;
