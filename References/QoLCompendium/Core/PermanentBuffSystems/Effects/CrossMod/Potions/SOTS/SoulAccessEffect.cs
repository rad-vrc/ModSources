...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SOTS.SoulAccessEffect
...
public class SoulAccessEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.secretsOfTheShadowsLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.secretsOfTheShadowsMod, "SoulAccess")] || PermanentBuffPlayer.PermanentSOTSBuffsBools[8])
      return;
