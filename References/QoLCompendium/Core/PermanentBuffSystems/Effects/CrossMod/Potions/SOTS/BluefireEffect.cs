...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SOTS.BluefireEffect
...
public class BluefireEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.secretsOfTheShadowsLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.secretsOfTheShadowsMod, "Bluefire")] || PermanentBuffPlayer.PermanentSOTSBuffsBools[1])
      return;
