...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SOTS.HarmonyEffect
...
public class HarmonyEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.secretsOfTheShadowsLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.secretsOfTheShadowsMod, "Harmony")] || PermanentBuffPlayer.PermanentSOTSBuffsBools[4])
      return;
