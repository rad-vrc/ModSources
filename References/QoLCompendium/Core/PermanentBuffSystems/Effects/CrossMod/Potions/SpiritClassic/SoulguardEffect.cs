...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SpiritClassic.SoulguardEffect
...
public class SoulguardEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "SoulPotionBuff")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[8])
      return;
