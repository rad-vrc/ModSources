...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SpiritClassic.ToxinEffect
...
public class ToxinEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "BismitePotionBuff")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[14])
      return;
