...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SpiritClassic.SoaringEffect
...
public class SoaringEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "FlightPotionBuff")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[10])
      return;
