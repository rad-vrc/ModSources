...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SpiritClassic.StarburnEffect
...
public class StarburnEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "StarPotionBuff")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[12])
      return;
