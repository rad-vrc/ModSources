...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SpiritClassic.ZephyrEffect
...
public class ZephyrEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "DoubleJumpPotionBuff")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[15])
      return;
