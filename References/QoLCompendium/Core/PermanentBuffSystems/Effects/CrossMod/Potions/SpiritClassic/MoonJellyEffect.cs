...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SpiritClassic.MoonJellyEffect
...
public class MoonJellyEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "MoonBlessing")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[6])
      return;
