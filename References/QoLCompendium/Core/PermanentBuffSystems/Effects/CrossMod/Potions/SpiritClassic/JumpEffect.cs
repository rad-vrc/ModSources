...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SpiritClassic.JumpEffect
...
public class JumpEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "PinkPotionBuff")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[4])
      return;
