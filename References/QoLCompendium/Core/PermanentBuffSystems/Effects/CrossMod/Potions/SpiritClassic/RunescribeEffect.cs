...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SpiritClassic.RunescribeEffect
...
public class RunescribeEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "RunePotionBuff")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[7])
      return;
