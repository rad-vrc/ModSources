...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.SpiritClassic.SpiritEffect
...
public class SpiritEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.spiritLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.spiritMod, "SpiritBuff")] || PermanentBuffPlayer.PermanentSpiritClassicBuffsBools[9])
      return;
