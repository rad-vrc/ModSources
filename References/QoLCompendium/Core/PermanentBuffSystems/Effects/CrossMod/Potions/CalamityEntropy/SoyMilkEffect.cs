...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.CalamityEntropy.SoyMilkEffect
...
public class SoyMilkEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.calamityEntropyLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.calamityEntropyMod, "SoyMilkBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[31 /*0x1F*/])
      return;
