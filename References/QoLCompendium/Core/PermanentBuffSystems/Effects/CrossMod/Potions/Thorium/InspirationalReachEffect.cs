...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.InspirationalReachEffect
...
public class InspirationalReachEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "InspirationReachPotionBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[15])
      return;
