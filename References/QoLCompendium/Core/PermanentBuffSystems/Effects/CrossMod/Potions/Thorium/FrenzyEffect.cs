...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.FrenzyEffect
...
public class FrenzyEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "FrenzyPotionBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[11])
      return;
