...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.ConflagrationEffect
...
public class ConflagrationEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "ConflagrationPotionBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[8])
      return;
