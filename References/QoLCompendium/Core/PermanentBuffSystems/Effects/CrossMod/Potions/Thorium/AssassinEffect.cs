...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.AssassinEffect
...
public class AssassinEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "AssassinPotionBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[4])
      return;
