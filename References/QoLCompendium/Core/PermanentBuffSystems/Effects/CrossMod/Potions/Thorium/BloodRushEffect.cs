...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.BloodRushEffect
...
public class BloodRushEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "BloodRush")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[5])
      return;
