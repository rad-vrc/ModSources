...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.FishRepellentEffect
...
public class FishRepellentEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "FishRepellentBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[19])
      return;
