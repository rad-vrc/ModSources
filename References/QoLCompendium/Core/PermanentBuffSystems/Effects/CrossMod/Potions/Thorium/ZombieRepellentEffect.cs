...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.ZombieRepellentEffect
...
public class ZombieRepellentEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "ZombieRepellentBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[22])
      return;
