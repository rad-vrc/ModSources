...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.WarmongerEffect
...
public class WarmongerEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "WarmongerBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[17])
      return;
