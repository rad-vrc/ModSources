...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.GlowingEffect
...
public class GlowingEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "GlowingPotionBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[12])
      return;
