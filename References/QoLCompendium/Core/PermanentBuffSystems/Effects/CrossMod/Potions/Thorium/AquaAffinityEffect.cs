...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.AquaAffinityEffect
...
public class AquaAffinityEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "AquaAffinity")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[1])
      return;
