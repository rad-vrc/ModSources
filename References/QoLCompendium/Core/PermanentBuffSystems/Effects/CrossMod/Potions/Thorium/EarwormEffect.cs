...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.EarwormEffect
...
public class EarwormEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "EarwormPotionBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[10])
      return;
