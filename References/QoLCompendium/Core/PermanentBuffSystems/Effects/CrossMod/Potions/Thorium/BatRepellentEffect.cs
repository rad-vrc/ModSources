...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.BatRepellentEffect
...
public class BatRepellentEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "BatRepellentBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[18])
      return;
