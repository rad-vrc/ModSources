...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.ArcaneEffect
...
public class ArcaneEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "ArcanePotionBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[2])
      return;
