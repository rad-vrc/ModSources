...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.HolyEffect
...
public class HolyEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "HolyPotionBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[13])
      return;
