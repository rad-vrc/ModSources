...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.HydrationEffect
...
public class HydrationEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "HydrationBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[14])
      return;
