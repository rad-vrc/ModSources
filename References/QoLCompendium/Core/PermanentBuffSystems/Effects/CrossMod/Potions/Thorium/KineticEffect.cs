...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Thorium.KineticEffect
...
public class KineticEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.thoriumLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.thoriumMod, "KineticPotionBuff")] || PermanentBuffPlayer.PermanentThoriumBuffsBools[16 /*0x10*/])
      return;
