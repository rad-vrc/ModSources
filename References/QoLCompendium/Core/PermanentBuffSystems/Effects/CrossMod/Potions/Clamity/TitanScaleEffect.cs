...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Clamity.TitanScaleEffect
...
public class TitanScaleEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.clamityAddonLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.clamityAddonMod, "TitanScalePotionBuff")] || PermanentBuffPlayer.PermanentCalamityBuffsBools[29])
      return;
