...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.Consolaria.WiesnbrauEffect
...
public class WiesnbrauEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.consolariaLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.consolariaMod, "Drunk")])
      return;
