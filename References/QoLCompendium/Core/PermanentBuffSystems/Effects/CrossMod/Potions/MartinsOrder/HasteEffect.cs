...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.MartinsOrder.HasteEffect
...
public class HasteEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "HasteBuff")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[6])
      return;
