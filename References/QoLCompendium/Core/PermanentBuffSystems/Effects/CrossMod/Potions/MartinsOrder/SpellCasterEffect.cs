...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.MartinsOrder.SpellCasterEffect
...
public class SpellCasterEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "CasterBuff")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[11])
      return;
