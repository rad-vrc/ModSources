...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.MartinsOrder.StarreachEffect
...
public class StarreachEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "Starreach")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[12])
      return;
