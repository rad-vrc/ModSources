...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.MartinsOrder.ZincPillEffect
...
public class ZincPillEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "ZincPillBuff")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[16 /*0x10*/])
      return;
