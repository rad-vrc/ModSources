...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.MartinsOrder.RockskinEffect
...
public class RockskinEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "RockskinBuff")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[8])
      return;
