...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.MartinsOrder.GourmetFlavorEffect
...
public class GourmetFlavorEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "Gourmet")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[5])
      return;
