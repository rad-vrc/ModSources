...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.MartinsOrder.EvocationEffect
...
public class EvocationEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "SummonSpeedBuff")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[4])
      return;
