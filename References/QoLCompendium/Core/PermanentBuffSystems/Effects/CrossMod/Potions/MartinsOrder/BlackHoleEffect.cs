...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.MartinsOrder.BlackHoleEffect
...
public class BlackHoleEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "BlackHoleBuff")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[0])
      return;
