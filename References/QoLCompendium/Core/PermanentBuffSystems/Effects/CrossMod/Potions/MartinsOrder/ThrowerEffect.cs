...
// Type: QoLCompendium.Core.PermanentBuffSystems.Effects.CrossMod.Potions.MartinsOrder.ThrowerEffect
...
public class ThrowerEffect : IPermanentModdedBuff
{
  ...
  {
    if (!ModConditions.martainsOrderLoaded || player.Player.buffImmune[Common.GetModBuff(ModConditions.martainsOrderMod, "ThrowerBuff")] || PermanentBuffPlayer.PermanentMartinsOrderBuffsBools[14])
      return;
