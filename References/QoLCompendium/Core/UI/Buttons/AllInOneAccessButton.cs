...
// Type: QoLCompendium.Core.UI.Buttons.AllInOneAccessButton
...
public class AllInOneAccessButton : CustomUIImageButton
{
  ...
  public AllInOneAccessButton(Asset<Texture2D> faceTexture)
    : base(ModContent.Request<Texture2D>("QoLCompendium/Assets/Backgrounds/Background_" + AllInOneAccessButton.backgroundTexture.ToString(), (AssetRequestMode) 2))
  {
    this.faceTexture = faceTexture;
    this.SetHoverImage(ModContent.Request<Texture2D>("QoLCompendium/Assets/Storages/Storage_Hover_" + AllInOneAccessButton.storageTexture.ToString(), (AssetRequestMode) 2));
  }
