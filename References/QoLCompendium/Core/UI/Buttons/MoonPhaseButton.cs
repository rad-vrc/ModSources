...
// Type: QoLCompendium.Core.UI.Buttons.MoonPhaseButton
...
public class MoonPhaseButton : CustomUIImageButton
{
  ...
  public MoonPhaseButton(Asset<Texture2D> faceTexture)
    : base(ModContent.Request<Texture2D>("QoLCompendium/Assets/Backgrounds/Background_" + MoonPhaseButton.backgroundTexture.ToString(), (AssetRequestMode) 2))
  {
    this.faceTexture = faceTexture;
    this.SetHoverImage(ModContent.Request<Texture2D>("QoLCompendium/Assets/Moons/Moon_Hover_" + MoonPhaseButton.moonTexture.ToString(), (AssetRequestMode) 2));
  }
