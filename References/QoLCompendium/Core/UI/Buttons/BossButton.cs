...
// Type: QoLCompendium.Core.UI.Buttons.BossButton
...
public class BossButton : CustomUIImageButton
{
  ...
  public BossButton(Asset<Texture2D> faceTexture)
    : base(ModContent.Request<Texture2D>("QoLCompendium/Assets/Backgrounds/Background_Red_" + BossButton.backgroundTexture.ToString(), (AssetRequestMode) 2))
  {
    this.faceTexture = faceTexture;
    this.SetHoverImage(ModContent.Request<Texture2D>("QoLCompendium/Assets/Summons/Boss_Hover_" + BossButton.bossTexture.ToString(), (AssetRequestMode) 2));
  }
