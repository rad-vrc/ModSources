...
// Type: QoLCompendium.Core.UI.Buttons.BiomeButton
...
public class BiomeButton : CustomUIImageButton
{
  ...
  public BiomeButton(Asset<Texture2D> faceTexture)
    : base(ModContent.Request<Texture2D>("QoLCompendium/Assets/Backgrounds/Background_" + BiomeButton.backgroundTexture.ToString(), (AssetRequestMode) 2))
  {
    this.faceTexture = faceTexture;
    this.SetHoverImage(ModContent.Request<Texture2D>("QoLCompendium/Assets/Biomes/Biome_Hover_" + BiomeButton.biomeTexture.ToString(), (AssetRequestMode) 2));
  }
