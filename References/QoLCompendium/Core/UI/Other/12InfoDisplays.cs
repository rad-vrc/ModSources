...
// Type: QoLCompendium.Core.UI.Other.DeathsInfoDisplay
...
{
  public virtual string Texture => "QoLCompendium/Assets/InfoDisplayIcons/DeathsInfoDisplay";

  public virtual bool Active() => Main.LocalPlayer.GetModPlayer<InfoPlayer>().skullWatch;
