...
// Type: QoLCompendium.Core.UI.Panels.EtherealCollectorNPCUI
...
public class EtherealCollectorNPCUI : UIState
{
  ...
  public virtual void OnInitialize()
  {
    ...
    ((StyleDimension) ref ((UIElement) this.ShopPanel).Top).Set(300f, 0.0f);
    ((StyleDimension) ref ((UIElement) this.ShopPanel).Width).Set(385f, 0.0f);
    ((StyleDimension) ref ((UIElement) this.ShopPanel).Height).Set(340f, 0.0f);
    ...
    UIText uiText1 = new UIText(UISystem.ECPotionText, 1f, false);
    ...
    UIText uiText2 = new UIText(UISystem.ECStationText, 1f, false);
    ...
    UIText uiText3 = new UIText(UISystem.ECMaterialText, 1f, false);
    ...
    UIText uiText4 = new UIText(UISystem.ECMaterial2Text, 1f, false);
    ...
    UIText uiText5 = new UIText(UISystem.ECBagText, 1f, false);
    ...
    UIText uiText6 = new UIText(UISystem.ECCrateText, 1f, false);
    ...
    UIText uiText7 = new UIText(UISystem.ECOreText, 1f, false);
    ...
    UIText uiText8 = new UIText(UISystem.ECNaturalBlockText, 1f, false);
    ...
    UIText uiText9 = new UIText(UISystem.ECBuildingBlockText, 1f, false);
    ...
    UIText uiText10 = new UIText(UISystem.ECHerbText, 1f, false);
    ...
    UIText uiText11 = new UIText(UISystem.ECFishText, 1f, false);
    ...
    if (!QoLCompendium.QoLCompendium.shopConfig.ECPotionShop)
    ...
    if (!QoLCompendium.QoLCompendium.shopConfig.ECStationShop)
    ...
    if (!QoLCompendium.QoLCompendium.shopConfig.ECMaterialShop)
    ...
    // ISSUE: method pointer
    ((UIElement) uiImageButton4).OnLeftClick += new UIElement.MouseEvent((object) this, __methodptr(Material2ShopClicked));
    ((UIElement) this.ShopPanel).Append((UIElement) uiImageButton4);
    UIImageButton uiImageButton5 = new UIImageButton(asset1);
    if (!QoLCompendium.QoLCompendium.shopConfig.ECBagShop)
    ...
    // ISSUE: method pointer
    ((UIElement) uiImageButton5).OnLeftClick += new UIElement.MouseEvent((object) this, __methodptr(BagShopClicked));
    ((UIElement) this.ShopPanel).Append((UIElement) uiImageButton5);
    UIImageButton uiImageButton6 = new UIImageButton(asset1);
    if (!QoLCompendium.QoLCompendium.shopConfig.ECCrateShop)
    ...
    // ISSUE: method pointer
    ((UIElement) uiImageButton6).OnLeftClick += new UIElement.MouseEvent((object) this, __methodptr(CrateShopClicked));
    ((UIElement) this.ShopPanel).Append((UIElement) uiImageButton6);
    UIImageButton uiImageButton7 = new UIImageButton(asset1);
    if (!QoLCompendium.QoLCompendium.shopConfig.ECOreShop)
    ...
    // ISSUE: method pointer
    ((UIElement) uiImageButton7).OnLeftClick += new UIElement.MouseEvent((object) this, __methodptr(OreShopClicked));
    ((UIElement) this.ShopPanel).Append((UIElement) uiImageButton7);
    UIImageButton uiImageButton8 = new UIImageButton(asset1);
    if (!QoLCompendium.QoLCompendium.shopConfig.ECNaturalBlocksShop)
    ...
    // ISSUE: method pointer
    ((UIElement) uiImageButton8).OnLeftClick += new UIElement.MouseEvent((object) this, __methodptr(NaturalShopClicked));
    ((UIElement) this.ShopPanel).Append((UIElement) uiImageButton8);
    UIImageButton uiImageButton9 = new UIImageButton(asset1);
    if (!QoLCompendium.QoLCompendium.shopConfig.ECBuildingBlocksShop)
    ...
    // ISSUE: method pointer
    ((UIElement) uiImageButton9).OnLeftClick += new UIElement.MouseEvent((object) this, __methodptr(BuildingShopClicked));
    ((UIElement) this.ShopPanel).Append((UIElement) uiImageButton9);
    UIImageButton uiImageButton10 = new UIImageButton(asset1);
    if (!QoLCompendium.QoLCompendium.shopConfig.ECHerbShop)
    ...
    // ISSUE: method pointer
    ((UIElement) uiImageButton10).OnLeftClick += new UIElement.MouseEvent((object) this, __methodptr(HerbShopClicked));
    ((UIElement) this.ShopPanel).Append((UIElement) uiImageButton10);
    UIImageButton uiImageButton11 = new UIImageButton(asset1);
    if (!QoLCompendium.QoLCompendium.shopConfig.ECFishShop)
    ...
    // ISSUE: method pointer
    ((UIElement) uiImageButton11).OnLeftClick += new UIElement.MouseEvent((object) this, __methodptr(FishShopClicked));
    ((UIElement) this.ShopPanel).Append((UIElement) uiImageButton11);
    UIImageButton uiImageButton12 = new UIImageButton(asset2);
    ((StyleDimension) ref ((UIElement) uiImageButton12).Left).Set(350f, 0.0f);
    ((StyleDimension) ref ((UIElement) uiImageButton12).Top).Set(10f, 0.0f);
    ...
    // ISSUE: method pointer
    ((UIElement) uiImageButton12).OnLeftClick += new UIElement.MouseEvent((object) this, __methodptr(CloseButtonClicked));
  ...
  {
    if (Main.GameUpdateCount - EtherealCollectorNPCUI.timeStart < 10U || !QoLCompendium.QoLCompendium.shopConfig.ECPotionShop)
      return;
  ...
  {
    if (Main.GameUpdateCount - EtherealCollectorNPCUI.timeStart < 10U || !QoLCompendium.QoLCompendium.shopConfig.ECStationShop)
      return;
  ...
  {
    if (Main.GameUpdateCount - EtherealCollectorNPCUI.timeStart < 10U || !QoLCompendium.QoLCompendium.shopConfig.ECMaterialShop)
      return;
  ...
  {
    if (Main.GameUpdateCount - EtherealCollectorNPCUI.timeStart < 10U || !QoLCompendium.QoLCompendium.shopConfig.ECBagShop)
      return;
  ...
  {
    if (Main.GameUpdateCount - EtherealCollectorNPCUI.timeStart < 10U || !QoLCompendium.QoLCompendium.shopConfig.ECCrateShop)
      return;
  ...
  {
    if (Main.GameUpdateCount - EtherealCollectorNPCUI.timeStart < 10U || !QoLCompendium.QoLCompendium.shopConfig.ECOreShop)
      return;
  ...
  {
    if (Main.GameUpdateCount - EtherealCollectorNPCUI.timeStart < 10U || !QoLCompendium.QoLCompendium.shopConfig.ECNaturalBlocksShop)
      return;
  ...
  {
    if (Main.GameUpdateCount - EtherealCollectorNPCUI.timeStart < 10U || !QoLCompendium.QoLCompendium.shopConfig.ECBuildingBlocksShop)
      return;
  ...
  {
    if (Main.GameUpdateCount - EtherealCollectorNPCUI.timeStart < 10U || !QoLCompendium.QoLCompendium.shopConfig.ECHerbShop)
      return;
  ...
  {
    if (Main.GameUpdateCount - EtherealCollectorNPCUI.timeStart < 10U || !QoLCompendium.QoLCompendium.shopConfig.ECFishShop)
      return;
