...
// Type: QoLCompendium.Content.Items.Tools.Staves.StaffOfShrooming
...
public class StaffOfShrooming : ModItem
{
  ...
  public virtual void ModifyTooltips(List<TooltipLine> tooltips)
  {
    ...
    TooltipLine tooltipLine2 = new TooltipLine(((ModType) this).Mod, "StaffOfShroomingEffect", Language.GetTextValue("Mods.QoLCompendium.CommonItemTooltips.StaffOfShroomingPlaceable"));
