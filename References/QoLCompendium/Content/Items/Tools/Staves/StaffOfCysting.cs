...
// Type: QoLCompendium.Content.Items.Tools.Staves.StaffOfCysting
...
public class StaffOfCysting : ModItem
{
  ...
  public virtual void ModifyTooltips(List<TooltipLine> tooltips)
  {
    ...
    TooltipLine tooltipLine2 = new TooltipLine(((ModType) this).Mod, "StaffOfCystingEffect", Language.GetTextValue("Mods.QoLCompendium.CommonItemTooltips.StaffOfCystingPlaceable"));
