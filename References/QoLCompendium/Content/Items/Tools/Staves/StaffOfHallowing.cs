...
// Type: QoLCompendium.Content.Items.Tools.Staves.StaffOfHallowing
...
public class StaffOfHallowing : ModItem
{
  ...
  public virtual void SetDefaults()
  {
    ...
    this.Item.SetShopValues((ItemRarityColor) 5, Item.sellPrice(0, 0, 50, 0));
  ...
  public virtual void ModifyTooltips(List<TooltipLine> tooltips)
  {
    ...
    TooltipLine tooltipLine2 = new TooltipLine(((ModType) this).Mod, "StaffOfHallowingEffect", Language.GetTextValue("Mods.QoLCompendium.CommonItemTooltips.StaffOfHallowingPlaceable"));
