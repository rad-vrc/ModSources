...
// Type: QoLCompendium.Content.Items.Tools.Staves.StaffOfAshing
...
public class StaffOfAshing : ModItem
{
  ...
  public virtual void ModifyTooltips(List<TooltipLine> tooltips)
  {
    ...
    TooltipLine tooltipLine2 = new TooltipLine(((ModType) this).Mod, "StaffOfAshingEffect", Language.GetTextValue("Mods.QoLCompendium.CommonItemTooltips.StaffOfAshingPlaceable"));
