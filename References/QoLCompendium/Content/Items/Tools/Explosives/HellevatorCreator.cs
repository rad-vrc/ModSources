...
// Type: QoLCompendium.Content.Items.Tools.Explosives.HellevatorCreator
...
public class HellevatorCreator : ModItem
{
  ...
  public virtual void SetDefaults()
  {
    ...
    ((Entity) this.Item).height = 31 /*0x1F*/;
    ...
    this.Item.shoot = ModContent.ProjectileType<HellevatorCreatorProj>();
    ...
    if (((Entity) player).direction < 0)
    {
      for (int index1 = -6; index1 <= 0; ++index1)
      {
        for (int index2 = 0; index2 <= 100; ++index2)
        {
          ...
          Projectile.NewProjectile(player.GetSource_ItemUse(this.Item, (string) null), Vector2.op_Addition(mouseWorld, new Vector2(48f, 16f)), Vector2.Zero, ModContent.ProjectileType<BuildIndicatorProjectile>(), 0, 0.0f, ((Entity) player).whoAmI, 0.0f, 0.0f, 0.0f);
        }
      }
    }
    else
