...
// Type: QoLCompendium.Content.Items.Tools.Explosives.Skybridger
...
public class Skybridger : ModItem
{
  ...
  public virtual void SetDefaults()
  {
    ...
    this.Item.shoot = ModContent.ProjectileType<SkybridgerProj>();
    ...
    float knockback)
  {
    ...
    if (player.altFunctionUse == 2)
      Projectile.NewProjectile(player.GetSource_ItemUse(((EntitySource_ItemUse) source).Item, (string) null), mouseWorld, Vector2.Zero, ModContent.ProjectileType<SkybridgerSingleProj>(), 0, 0.0f, ((Entity) player).whoAmI, 0.0f, 0.0f, 0.0f);
    else
