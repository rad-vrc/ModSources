...
// Type: QoLCompendium.Content.Items.Tools.Summons.EmpressOfLightSummon
...
public class EmpressOfLightSummon : ModItem
{
    ...
    float knockback)
  {
    ...
    Projectile.NewProjectile(player.GetSource_ItemUse(this.Item, (string) null), vector2, Vector2.Zero, ModContent.ProjectileType<NPCSpawner>(), 0, 0.0f, ((Entity) player).whoAmI, 636f, 0.0f, 0.0f);
