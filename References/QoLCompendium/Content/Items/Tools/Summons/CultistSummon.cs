...
// Type: QoLCompendium.Content.Items.Tools.Summons.CultistSummon
...
public class CultistSummon : ModItem
{
  ...
  {
    ItemID.Sets.SortingPriorityBossSpawns[this.Type] = 16 /*0x10*/;
    ...
    float knockback)
  {
    ...
    Projectile.NewProjectile(player.GetSource_ItemUse(this.Item, (string) null), vector2, Vector2.Zero, ModContent.ProjectileType<NPCSpawner>(), 0, 0.0f, ((Entity) player).whoAmI, 439f, 0.0f, 0.0f);
