...
// Type: QoLCompendium.Content.Items.Tools.Summons.CrossMod.LeviathanAnahitaSummon
...
public class LeviathanAnahitaSummon : ModItem
{
    ...
    float knockback)
  {
    ...
    Projectile.NewProjectile(player.GetSource_ItemUse(this.Item, (string) null), vector2, Vector2.Zero, ModContent.ProjectileType<NPCSpawner>(), 0, 0.0f, ((Entity) player).whoAmI, (float) Common.GetModNPC(ModConditions.calamityMod, "Anahita"), 0.0f, 0.0f);
