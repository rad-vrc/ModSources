...
// Type: QoLCompendium.Content.Items.Tools.Summons.CrossMod.OldDukeSummon
...
public class OldDukeSummon : ModItem
{
  ...
  {
    ItemID.Sets.SortingPriorityBossSpawns[this.Type] = 19;
  ...
  public virtual void SetDefaults()
  {
    ...
    this.Item.SetShopValues((ItemRarityColor) 10, Item.sellPrice(0, 0, 0, 0));
  }
    ...
    float knockback)
  {
    ...
    Projectile.NewProjectile(player.GetSource_ItemUse(this.Item, (string) null), vector2, Vector2.Zero, ModContent.ProjectileType<NPCSpawner>(), 0, 0.0f, ((Entity) player).whoAmI, (float) Common.GetModNPC(ModConditions.calamityMod, "OldDuke"), 0.0f, 0.0f);
