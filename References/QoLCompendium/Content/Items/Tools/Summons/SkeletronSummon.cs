...
// Type: QoLCompendium.Content.Items.Tools.Summons.SkeletronSummon
...
public class SkeletronSummon : ModItem
{
  ...
  {
    ItemID.Sets.SortingPriorityBossSpawns[this.Type] = 5;
  ...
  public virtual bool CanUseItem(Player player) => !NPC.AnyNPCs(35);
    ...
    float knockback)
  {
    ...
    Projectile.NewProjectile(player.GetSource_ItemUse(this.Item, (string) null), vector2, Vector2.Zero, ModContent.ProjectileType<NPCSpawner>(), 0, 0.0f, ((Entity) player).whoAmI, 35f, 0.0f, 0.0f);
