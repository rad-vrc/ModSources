...
// Type: QoLCompendium.Content.Items.Tools.Summons.PlanteraSummon
...
public class PlanteraSummon : ModItem
{
  ...
  public virtual void SetDefaults()
  {
    ...
    this.Item.SetShopValues((ItemRarityColor) 6, Item.sellPrice(0, 0, 0, 0));
  }
    ...
    float knockback)
  {
    ...
    Projectile.NewProjectile(player.GetSource_ItemUse(this.Item, (string) null), vector2, Vector2.Zero, ModContent.ProjectileType<NPCSpawner>(), 0, 0.0f, ((Entity) player).whoAmI, 262f, 0.0f, 0.0f);
  ...
  public virtual void AddRecipes()
  {
    ...
    itemRecipe.AddIngredient(176 /*0xB0*/, 10);
