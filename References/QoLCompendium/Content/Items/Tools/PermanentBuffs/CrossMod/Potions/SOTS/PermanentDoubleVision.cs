...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.SOTS.PermanentDoubleVision
...
public class PermanentDoubleVision : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new DoubleVisionEffect());
  }
}
