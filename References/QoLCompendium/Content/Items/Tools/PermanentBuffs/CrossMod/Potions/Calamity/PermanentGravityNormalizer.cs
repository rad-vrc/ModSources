...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.Calamity.PermanentGravityNormalizer
...
public class PermanentGravityNormalizer : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new GravityNormalizerEffect());
  }
}
