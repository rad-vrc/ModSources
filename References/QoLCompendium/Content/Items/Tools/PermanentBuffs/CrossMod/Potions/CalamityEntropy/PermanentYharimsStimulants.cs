...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.CalamityEntropy.PermanentYharimsStimulants
...
public class PermanentYharimsStimulants : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new YharimsStimulantsEffect());
  }
}
