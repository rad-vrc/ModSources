...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.MartinsOrder.PermanentSpellCaster
...
public class PermanentSpellCaster : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new SpellCasterEffect());
  }
}
