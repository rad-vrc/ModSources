...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.Clamity.PermanentTitanScale
...
public class PermanentTitanScale : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new TitanScaleEffect());
  }
}
