...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.Thorium.PermanentInspirationalReach
...
public class PermanentInspirationalReach : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new InspirationalReachEffect());
  }
}
