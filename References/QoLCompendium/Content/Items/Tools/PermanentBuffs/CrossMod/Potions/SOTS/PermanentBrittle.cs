...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.SOTS.PermanentBrittle
...
public class PermanentBrittle : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new BrittleEffect());
  }
}
