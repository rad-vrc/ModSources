...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.ThoriumBossRework.PermanentInspirationRegeneration
...
public class PermanentInspirationRegeneration : IPermanentModdedBuffItem
{
  ...
  {
    get => Common.ModBuffAsset(ModConditions.thoriumBossReworkMod, ModContent.BuffType<Inspired>());
  }
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new InspirationRegenerationEffect());
  }
}
