...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.SOTS.PermanentNightmare
...
public class PermanentNightmare : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new NightmareEffect());
  }
}
