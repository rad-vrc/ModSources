...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.MartinsOrder.PermanentShooter
...
public class PermanentShooter : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ShooterEffect());
  }
}
