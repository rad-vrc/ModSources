...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.MartinsOrder.PermanentStarreach
...
public class PermanentStarreach : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new StarreachEffect());
  }
}
