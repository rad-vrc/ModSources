...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.MartinsOrder.PermanentThrower
...
public class PermanentThrower : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ThrowerEffect());
  }
}
