...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.Consolaria.PermanentWiesnbrau
...
[JITWhenModsEnabled(new string[] {"Consolaria"})]
[ExtendsFromMod(new string[] {"Consolaria"})]
public class PermanentWiesnbrau : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new WiesnbrauEffect());
  }
}
