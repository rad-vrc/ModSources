...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.SOTS.PermanentHarmony
...
public class PermanentHarmony : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new HarmonyEffect());
  }
}
