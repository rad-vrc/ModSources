...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.MartinsOrder.PermanentSweeper
...
public class PermanentSweeper : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new SweeperEffect());
  }
}
