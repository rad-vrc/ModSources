...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.Calamity.PermanentCalcium
...
public class PermanentCalcium : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new CalciumEffect());
  }
}
