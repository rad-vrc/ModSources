...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Flasks.Calamity.PermanentFlaskOfHolyFlames
...
public class PermanentFlaskOfHolyFlames : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new WeaponImbueHolyFlamesEffect());
  }
}
