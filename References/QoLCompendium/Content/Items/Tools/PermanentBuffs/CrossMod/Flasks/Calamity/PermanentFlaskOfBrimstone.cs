...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Flasks.Calamity.PermanentFlaskOfBrimstone
...
public class PermanentFlaskOfBrimstone : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new WeaponImbueBrimstoneEffect());
  }
}
