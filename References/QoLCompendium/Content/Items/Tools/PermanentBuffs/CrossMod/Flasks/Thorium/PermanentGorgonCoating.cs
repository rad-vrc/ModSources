...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Flasks.Thorium.PermanentGorgonCoating
...
public class PermanentGorgonCoating : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ThrownWeaponImbueGorgonJuiceEffect());
  }
}
