...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Flasks.Thorium.PermanentSporeCoating
...
public class PermanentSporeCoating : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ThrownWeaponImbueSporesEffect());
  }
}
