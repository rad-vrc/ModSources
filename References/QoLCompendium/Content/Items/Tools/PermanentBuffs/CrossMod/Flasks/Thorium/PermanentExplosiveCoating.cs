...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Flasks.Thorium.PermanentExplosiveCoating
...
public class PermanentExplosiveCoating : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ThrownWeaponImbueExplosiveEffect());
  }
}
