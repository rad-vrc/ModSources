...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Flasks.Calamity.PermanentFlaskOfCrumbling
...
public class PermanentFlaskOfCrumbling : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new WeaponImbueCrumblingEffect());
  }
}
