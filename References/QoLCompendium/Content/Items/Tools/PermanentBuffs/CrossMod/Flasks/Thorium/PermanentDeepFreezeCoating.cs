...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Flasks.Thorium.PermanentDeepFreezeCoating
...
public class PermanentDeepFreezeCoating : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ThrownWeaponImbueDeepFreezeEffect());
  }
}
