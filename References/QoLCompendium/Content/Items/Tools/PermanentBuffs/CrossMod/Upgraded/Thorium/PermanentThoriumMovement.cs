...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Thorium.PermanentThoriumMovement
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentThoriumMovement";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ThoriumMovementEffect());
  }
}
