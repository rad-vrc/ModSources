...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Calamity.PermanentCalamityFarming
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentCalamityFarming";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new CalamityFarmingEffect());
  }
}
