...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.SpiritClassic.PermanentSpiritClassic
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentSpiritClassic";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new SpiritClassicEffect());
  }
}
