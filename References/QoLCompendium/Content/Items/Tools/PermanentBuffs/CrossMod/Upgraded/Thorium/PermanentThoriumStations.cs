...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Thorium.PermanentThoriumStations
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentThoriumStations";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ThoriumStationsEffect());
  }
}
