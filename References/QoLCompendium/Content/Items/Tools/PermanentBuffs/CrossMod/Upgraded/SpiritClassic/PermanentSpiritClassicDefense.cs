...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.SpiritClassic.PermanentSpiritClassicDefense
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentSpiritClassicDefense";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new SpiritClassicDefenseEffect());
  }
}
