...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Calamity.PermanentCalamityDamage
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentCalamityDamage";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new CalamityDamageEffect());
  }
}
