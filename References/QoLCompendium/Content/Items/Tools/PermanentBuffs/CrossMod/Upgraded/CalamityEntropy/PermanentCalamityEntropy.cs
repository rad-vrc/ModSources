...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.CalamityEntropy.PermanentCalamityEntropy
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentCalamityEntropy";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new CalamityEntropyEffect());
  }
}
