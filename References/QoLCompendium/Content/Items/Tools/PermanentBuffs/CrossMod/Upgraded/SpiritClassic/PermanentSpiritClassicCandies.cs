...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.SpiritClassic.PermanentSpiritClassicCandies
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentSpiritClassicCandies";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new SpiritClassicCandyEffect());
  }
}
