...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Calamity.PermanentCalamityMovement
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentCalamityMovement";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new CalamityMovementEffect());
  }
}
