...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Calamity.PermanentCalamity
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentCalamity";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new CalamityEffect());
  }
}
