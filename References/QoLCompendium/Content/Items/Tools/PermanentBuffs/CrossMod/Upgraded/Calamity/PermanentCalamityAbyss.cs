...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Calamity.PermanentCalamityAbyss
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentCalamityAbyss";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new CalamityAbyssEffect());
  }
}
