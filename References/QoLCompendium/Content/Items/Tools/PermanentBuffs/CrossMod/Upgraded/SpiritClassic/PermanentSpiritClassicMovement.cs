...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.SpiritClassic.PermanentSpiritClassicMovement
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentSpiritClassicMovement";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new SpiritClassicMovementEffect());
  }
}
