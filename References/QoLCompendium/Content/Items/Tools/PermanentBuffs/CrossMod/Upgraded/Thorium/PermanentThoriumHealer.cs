...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Thorium.PermanentThoriumHealer
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentThoriumHealer";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ThoriumHealerEffect());
  }
}
