...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.MartinsOrder.PermanentMartinsOrderStations
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentMartinsOrderStations";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new MartinsOrderStationsEffect());
  }
}
