...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Thorium.PermanentThoriumRepellent
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentThoriumRepellent";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ThoriumRepellentEffect());
  }
}
