...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Thorium.PermanentThoriumThrower
...
{
  public virtual string Texture => "QoLCompendium/Assets/Items/PermanentThoriumThrower";
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ThoriumThrowerEffect());
  }
}
