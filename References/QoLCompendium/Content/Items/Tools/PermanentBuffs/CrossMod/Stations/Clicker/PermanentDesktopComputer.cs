...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Stations.Clicker.PermanentDesktopComputer
...
public class PermanentDesktopComputer : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new DesktopComputerEffect());
  }
}
