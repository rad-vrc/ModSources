...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Stations.MartinsOrder.PermanentArcheology
...
public class PermanentArcheology : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ArcheologyEffect());
  }
}
