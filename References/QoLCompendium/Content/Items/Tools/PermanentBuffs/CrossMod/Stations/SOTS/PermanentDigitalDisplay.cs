...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Stations.SOTS.PermanentDigitalDisplay
...
public class PermanentDigitalDisplay : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new DigitalDisplayEffect());
  }
}
