...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Stations.Thorium.PermanentNinjaRack
...
public class PermanentNinjaRack : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new NinjaRackEffect());
  }
}
