...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Stations.Thorium.PermanentAltar
...
public class PermanentAltar : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new AltarEffect());
  }
}
