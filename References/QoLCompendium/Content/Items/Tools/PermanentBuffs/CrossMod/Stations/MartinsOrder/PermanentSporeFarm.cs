...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Stations.MartinsOrder.PermanentSporeFarm
...
public class PermanentSporeFarm : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new SporeFarmEffect());
  }
}
