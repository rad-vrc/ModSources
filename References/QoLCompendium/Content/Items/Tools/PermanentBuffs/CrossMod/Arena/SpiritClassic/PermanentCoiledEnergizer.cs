...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Arena.SpiritClassic.PermanentCoiledEnergizer
...
public class PermanentCoiledEnergizer : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new CoiledEnergizerEffect());
  }
}
