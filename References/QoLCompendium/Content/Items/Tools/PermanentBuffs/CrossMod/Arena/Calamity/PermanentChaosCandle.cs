...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Arena.Calamity.PermanentChaosCandle
...
public class PermanentChaosCandle : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new ChaosCandleEffect());
  }
}
