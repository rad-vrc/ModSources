...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Arena.SpiritClassic.PermanentSunPot
...
public class PermanentSunPot : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new SunPotEffect());
  }
}
