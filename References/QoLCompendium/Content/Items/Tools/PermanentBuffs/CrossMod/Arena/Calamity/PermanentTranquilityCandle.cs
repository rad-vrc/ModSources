...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Arena.Calamity.PermanentTranquilityCandle
...
public class PermanentTranquilityCandle : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new TranquilityCandleEffect());
  }
}
