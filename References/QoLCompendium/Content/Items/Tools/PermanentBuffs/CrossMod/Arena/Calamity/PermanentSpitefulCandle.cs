...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Arena.Calamity.PermanentSpitefulCandle
...
public class PermanentSpitefulCandle : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new SpitefulCandleEffect());
  }
}
