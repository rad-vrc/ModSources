...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Arena.SpiritClassic.PermanentTheCouch
...
public class PermanentTheCouch : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new TheCouchEffect());
  }
}
