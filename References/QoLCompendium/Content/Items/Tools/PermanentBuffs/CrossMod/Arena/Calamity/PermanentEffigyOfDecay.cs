...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Arena.Calamity.PermanentEffigyOfDecay
...
public class PermanentEffigyOfDecay : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new EffigyOfDecayEffect());
  }
}
