...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Arena.SpiritClassic.PermanentKoiTotem
...
public class PermanentKoiTotem : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new KoiTotemEffect());
  }
}
