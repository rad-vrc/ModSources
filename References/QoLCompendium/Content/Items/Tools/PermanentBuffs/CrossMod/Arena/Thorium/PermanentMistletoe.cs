...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Arena.Thorium.PermanentMistletoe
...
public class PermanentMistletoe : IPermanentModdedBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.modPotionEffects.Add((IPermanentModdedBuff) new MistletoeEffect());
  }
}
