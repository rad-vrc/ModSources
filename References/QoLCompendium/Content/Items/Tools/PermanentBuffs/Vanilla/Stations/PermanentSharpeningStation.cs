...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Stations.PermanentSharpeningStation
...
public class PermanentSharpeningStation : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new SharpeningStationEffect());
  }
}
