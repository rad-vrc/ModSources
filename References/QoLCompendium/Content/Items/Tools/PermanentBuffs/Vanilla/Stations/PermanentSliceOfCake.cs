...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Stations.PermanentSliceOfCake
...
public class PermanentSliceOfCake : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new SliceOfCakeEffect());
  }
}
