...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Stations.PermanentCrystalBall
...
public class PermanentCrystalBall : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new CrystalBallEffect());
  }
}
