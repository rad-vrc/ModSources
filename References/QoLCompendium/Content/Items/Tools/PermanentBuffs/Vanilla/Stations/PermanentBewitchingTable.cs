...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Stations.PermanentBewitchingTable
...
public class PermanentBewitchingTable : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new BewitchingTableEffect());
  }
}
