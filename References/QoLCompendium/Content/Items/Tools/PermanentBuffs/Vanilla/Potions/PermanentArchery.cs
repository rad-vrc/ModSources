...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Potions.PermanentArchery
...
public class PermanentArchery : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new ArcheryEffect());
  }
}
