...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Potions.PermanentExquisitelyStuffed
...
public class PermanentExquisitelyStuffed : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new ExquisitelyStuffedEffect());
  }
}
