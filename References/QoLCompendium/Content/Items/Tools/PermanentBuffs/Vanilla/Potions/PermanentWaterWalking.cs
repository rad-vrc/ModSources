...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Potions.PermanentWaterWalking
...
public class PermanentWaterWalking : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new WaterWalkingEffect());
  }
}
