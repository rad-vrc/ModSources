...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Potions.PermanentGravitation
...
public class PermanentGravitation : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new GravitationEffect());
  }
}
