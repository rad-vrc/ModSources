...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Arena.PermanentStarInABottle
...
public class PermanentStarInABottle : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new StarInABottleEffect());
  }
}
