...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Arena.PermanentShadowCandle
...
public class PermanentShadowCandle : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new ShadowCandleEffect());
  }
}
