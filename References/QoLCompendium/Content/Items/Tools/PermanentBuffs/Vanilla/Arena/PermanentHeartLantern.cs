...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Arena.PermanentHeartLantern
...
public class PermanentHeartLantern : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new HeartLanternEffect());
  }
}
