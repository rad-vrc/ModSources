...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Arena.PermanentSunflower
...
public class PermanentSunflower : IPermanentBuffItem
{
  ...
  public virtual void AddRecipes()
  {
    ...
    itemRecipe.AddIngredient(63 /*0x3F*/, 3);
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new SunflowerEffect());
  }
}
