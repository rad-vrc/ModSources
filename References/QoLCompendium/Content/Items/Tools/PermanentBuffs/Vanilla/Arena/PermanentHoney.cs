...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Arena.PermanentHoney
...
public class PermanentHoney : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new HoneyEffect());
  }
}
