...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Flasks.PermanentFlaskOfGold
...
public class PermanentFlaskOfGold : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new WeaponImbueGoldEffect());
  }
}
