...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Flasks.PermanentFlaskOfVenom
...
public class PermanentFlaskOfVenom : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new WeaponImbueVenomEffect());
  }
}
