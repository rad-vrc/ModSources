...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Flasks.PermanentFlaskOfFire
...
public class PermanentFlaskOfFire : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new WeaponImbueFireEffect());
  }
}
