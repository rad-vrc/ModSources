...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Flasks.PermanentFlaskOfPoison
...
public class PermanentFlaskOfPoison : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new WeaponImbuePoisonEffect());
  }
}
