...
// Type: QoLCompendium.Content.Items.Tools.PermanentBuffs.Vanilla.Flasks.PermanentFlaskOfParty
...
public class PermanentFlaskOfParty : IPermanentBuffItem
{
  ...
  internal override void ApplyBuff(PermanentBuffPlayer player)
  {
    ...
    player.potionEffects.Add((IPermanentBuff) new WeaponImbueConfettiEffect());
  }
}
