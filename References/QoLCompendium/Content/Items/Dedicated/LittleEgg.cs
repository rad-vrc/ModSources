...
// Type: QoLCompendium.Content.Items.Dedicated.LittleEgg
...
public class LittleEgg : ModItem
{
  ...
  public virtual void SetDefaults()
  {
    ...
    this.Item.shoot = ModContent.ProjectileType<LittleYagi>();
    this.Item.buffType = ModContent.BuffType<LittleYagiBuff>();
  ...
  {
    TooltipLine tooltipLine = new TooltipLine(((ModType) this).Mod, "Dedicated", Language.GetTextValue("Mods.QoLCompendium.DedicatedTooltips.Jay"))
    {
