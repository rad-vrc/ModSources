...
// Type: QoLCompendium.Content.Items.Dedicated.Lamp
...
public class Lamp : ModItem
{
  ...
  public virtual void SetDefaults()
  {
    ...
    this.Item.shoot = ModContent.ProjectileType<Moth>();
    this.Item.buffType = ModContent.BuffType<MothBuff>();
  ...
  {
    TooltipLine tooltipLine = new TooltipLine(((ModType) this).Mod, "Dedicated", Language.GetTextValue("Mods.QoLCompendium.DedicatedTooltips.Jack"))
    {
