...
// Type: QoLCompendium.Content.Items.Placeables.CraftingStations.CrossMod.BasicThoriumCraftingMonolith
...
public class BasicThoriumCraftingMonolith : ModItem
{
  ...
  {
    this.Item.DefaultToPlaceableTile(ModContent.TileType<BasicThoriumMonolithTile>(), 0);
