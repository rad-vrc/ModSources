...
// Type: QoLCompendium.Content.Items.Placeables.CraftingStations.CrossMod.HardmodeCalamityCraftingMonolith
...
public class HardmodeCalamityCraftingMonolith : ModItem
{
  ...
  {
    this.Item.DefaultToPlaceableTile(ModContent.TileType<HardmodeCalamityMonolithTile>(), 0);
    this.Item.SetShopValues((ItemRarityColor) 8, Item.buyPrice(0, 5, 0, 0));
  }
