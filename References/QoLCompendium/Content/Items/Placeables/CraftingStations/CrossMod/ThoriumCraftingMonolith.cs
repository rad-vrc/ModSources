...
// Type: QoLCompendium.Content.Items.Placeables.CraftingStations.CrossMod.ThoriumCraftingMonolith
...
public class ThoriumCraftingMonolith : ModItem
{
  ...
  {
    this.Item.DefaultToPlaceableTile(ModContent.TileType<ThoriumMonolithTile>(), 0);
