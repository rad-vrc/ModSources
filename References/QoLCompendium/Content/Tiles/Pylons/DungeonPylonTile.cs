...
// Type: QoLCompendium.Content.Tiles.Pylons.DungeonPylonTile
...
public class DungeonPylonTile : ModPylon
{
  ...
  {
    this.crystalTexture = ModContent.Request<Texture2D>("QoLCompendium/Assets/PylonCrystals/DungeonPylonTile_Crystal", (AssetRequestMode) 2);
    ...
    this.mapIcon = ModContent.Request<Texture2D>("QoLCompendium/Assets/MapIcons/DungeonPylonTile_MapIcon", (AssetRequestMode) 2);
  }
  ...
  public virtual void SetStaticDefaults()
  {
    ...
    ((ModTile) this).AddMapEntry(Color.Aqua, ((ModBlockType) this).CreateMapEntryName());
  ...
  public virtual NPCShop.Entry GetNPCShopEntry()
  {
    ...
    return new NPCShop.Entry(ModContent.ItemType<DungeonPylon>(), new Condition[1]
    {
      Condition.InDungeon
    });
  }
  ...
  {
    this.DefaultDrawPylonCrystal(spriteBatch, i, j, this.crystalTexture, this.crystalHighlightTexture, new Vector2(-1f, -12f), Color.op_Multiply(Color.White, 0.1f), Common.ColorSwap(Color.Aqua, Color.DodgerBlue, 1.5f), 4, this.CrystalVerticalFrameCount);
  }
  ...
  public virtual void DrawMapIcon(
    ...
    float selectedScale)
  {
    this.DefaultMapClickHandle(this.DefaultDrawMapIcon(ref context, this.mapIcon, Vector2.op_Addition(Utils.ToVector2(pylonInfo.PositionInTiles), new Vector2(1.5f, 2f)), drawColor, deselectedScale, selectedScale), pylonInfo, ModContent.GetInstance<DungeonPylon>().DisplayName.Key, ref mouseOverText);
  }
}
