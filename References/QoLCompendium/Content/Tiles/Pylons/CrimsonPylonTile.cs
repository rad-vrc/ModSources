...
// Type: QoLCompendium.Content.Tiles.Pylons.CrimsonPylonTile
...
public class CrimsonPylonTile : ModPylon
{
  ...
  {
    this.crystalTexture = ModContent.Request<Texture2D>("QoLCompendium/Assets/PylonCrystals/CrimsonPylonTile_Crystal", (AssetRequestMode) 2);
    ...
    this.mapIcon = ModContent.Request<Texture2D>("QoLCompendium/Assets/MapIcons/CrimsonPylonTile_MapIcon", (AssetRequestMode) 2);
  }
  ...
  public virtual void SetStaticDefaults()
  {
    ...
    ((ModTile) this).AddMapEntry(Color.Firebrick, ((ModBlockType) this).CreateMapEntryName());
  ...
  public virtual NPCShop.Entry GetNPCShopEntry()
  {
    ...
    return new NPCShop.Entry(ModContent.ItemType<CrimsonPylon>(), new Condition[1]
    {
      Condition.InCrimson
    });
  }
  ...
  {
    this.DefaultDrawPylonCrystal(spriteBatch, i, j, this.crystalTexture, this.crystalHighlightTexture, new Vector2(-1f, -12f), Color.op_Multiply(Color.White, 0.1f), Common.ColorSwap(Color.IndianRed, Color.OrangeRed, 1.5f), 4, this.CrystalVerticalFrameCount);
  }
  ...
  public virtual void DrawMapIcon(
    ...
    float selectedScale)
  {
    this.DefaultMapClickHandle(this.DefaultDrawMapIcon(ref context, this.mapIcon, Vector2.op_Addition(Utils.ToVector2(pylonInfo.PositionInTiles), new Vector2(1.5f, 2f)), drawColor, deselectedScale, selectedScale), pylonInfo, ModContent.GetInstance<CrimsonPylon>().DisplayName.Key, ref mouseOverText);
  }
}
