...
// Type: QoLCompendium.Content.Projectiles.MobileStorages.FlyingSafeProjectile
...
public class FlyingSafeProjectile : ModProjectile
{
  ...
  public virtual void SetDefaults()
  {
    ...
    ((Entity) this.Projectile).height = 32 /*0x20*/;
  ...
  public virtual void PostAI()
  {
    ...
    PortableBankAI.BankAI(this.Projectile, ModContent.ItemType<FlyingSafe>(), -3, ref modPlayer.safe, player, modPlayer);
  }
