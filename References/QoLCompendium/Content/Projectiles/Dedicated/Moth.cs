...
// Type: QoLCompendium.Content.Projectiles.Dedicated.Moth
...
public class Moth : ModProjectile
{
  public virtual void SetStaticDefaults()
  {
    ...
    ProjectileID.Sets.CharacterPreviewAnimations[this.Projectile.type] = ProjectileID.Sets.SimpleLoop(0, Main.projFrames[this.Projectile.type], 6, false).WithOffset(-10f, -20f).WithSpriteDirection(-1).WithCode(Moth.\u003C\u003EO.\u003C0\u003E__Float ?? (Moth.\u003C\u003EO.\u003C0\u003E__Float = new SettingsForCharacterPreview.CustomAnimationCode((object) null, __methodptr(Float))));
  }
  ...
  public virtual void SetDefaults()
  {
    ...
    this.AIType = 380;
    ((Entity) this.Projectile).width = 48 /*0x30*/;
