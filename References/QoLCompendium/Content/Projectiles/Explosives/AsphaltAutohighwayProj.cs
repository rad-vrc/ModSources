...
// Type: QoLCompendium.Content.Projectiles.Explosives.AsphaltAutohighwayProj
...
public class AsphaltAutohighwayProj : ModProjectile
{
  ...
  {
    get => "QoLCompendium/Content/Items/Tools/Explosives/AsphaltAutohighway";
  }
        ...
        if (x >= 0 && x < Main.maxTilesX && y >= 0 && y < Main.maxTilesY)
        {
          ...
          if (!Tile.op_Equality(tile, (ArgumentException) null))
          {
            ...
            if (index2 == -30 || index2 == 0)
            {
              ...
              WorldGen.PlaceTile(x, y, ModContent.TileType<AsphaltPlatformTile>(), false, false, -1, 0);
              if (Main.netMode == 2)
