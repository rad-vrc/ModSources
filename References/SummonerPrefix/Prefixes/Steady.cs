...
// Type: SummonerPrefix.Prefixes.Steady
...
public class Steady : ModPrefix
{
  ...
  {
    item.global().MinionSpeedMult += Steady.MinionSpeedMult - 1f;
  }
  ...
  public virtual IEnumerable<TooltipLine> GetTooltipLines(Item item)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    TooltipLine tl = new TooltipLine(((ModType) steady).Mod, "PrefixDescription", steady.AdditionalTooltip.Value)
    {
      IsModifier = true,
      IsModifierBad = false
    };
    tl.Replace("{}", (1f - Steady.MinionSpeedMult).ToPercent().ToString());
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = tl;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
