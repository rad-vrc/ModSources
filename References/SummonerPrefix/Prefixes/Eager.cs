...
// Type: SummonerPrefix.Prefixes.Eager
...
public class Eager : ModPrefix
{
  ...
  {
    item.global().MinionSpeedMult += Eager.MinionSpeedMult - 1f;
  }
  ...
  public virtual IEnumerable<TooltipLine> GetTooltipLines(Item item)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    TooltipLine tl = new TooltipLine(((ModType) eager).Mod, "PrefixDescription", eager.AdditionalTooltip.Value)
    {
      IsModifier = true,
      IsModifierBad = false
    };
    tl.Replace("{}", (Eager.MinionSpeedMult - 1f).ToPercent().ToString());
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = tl;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
