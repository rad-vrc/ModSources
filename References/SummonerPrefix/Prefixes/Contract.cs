...
// Type: SummonerPrefix.Prefixes.Contract
...
public class Contract : ModPrefix
{
  ...
  public virtual void Apply(Item item) => item.global().MinionLifeSteal += Contract.LifeSteal;
  ...
  public virtual IEnumerable<TooltipLine> GetTooltipLines(Item item)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    TooltipLine tl = new TooltipLine(((ModType) contract).Mod, "PrefixDescription", contract.AdditionalTooltip.Value)
    {
      IsModifier = true,
      IsModifierBad = false
    };
    tl.Replace("{A}", Contract.LifeSteal.ToPercent().ToString());
    tl.Replace("{B}", Contract.ArmorDecrease.ToString());
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = tl;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
