...
namespace Terraria.Initializers
{
	...
	{
		// Token: 0x060034AC RID: 13484 RVA: 0x0055E128 File Offset: 0x0055C328
		public static void Load()
		{
			if (Main.netMode != 2)
			{
				...
				if ((value = AchievementInitializer.<>O.<0>__OnAchievementCompleted) == null)
				{
					value = (AchievementInitializer.<>O.<0>__OnAchievementCompleted = new Achievement.AchievementCompleted(AchievementInitializer.OnAchievementCompleted));
				}
		...
		// Token: 0x060034AD RID: 13485 RVA: 0x005603FC File Offset: 0x0055E5FC
		private static void OnAchievementCompleted(Achievement achievement)
		{
			...
			{
				SoundEngine.PlayTrackedSound(SoundID.AchievementComplete, null);
			}
		}
		...
		private static class <>O
		{
			...
			public static Achievement.AchievementCompleted <0>__OnAchievementCompleted;
		}
	}
}
