...
namespace Terraria.Initializers
{
	...
	{
		// Token: 0x060034F1 RID: 13553 RVA: 0x00566EC0 File Offset: 0x005650C0
		public static void Load()
		{
			...
			Filters.Scene["Test3"] = new Filter(new ScreenShaderData("FilterTest3").UseImage("Images/Extra_" + 156.ToString(), 0, null), EffectPriority.VeryHigh);
			Overlays.Scene.Load();
			Filters.Scene.Load();
			ScreenEffectInitializer.LoadSkies();
		}

		// Token: 0x060034F2 RID: 13554 RVA: 0x00567514 File Offset: 0x00565714
