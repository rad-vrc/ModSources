...
namespace Terraria.GameContent.Generation
{
	...
	{
		// Token: 0x060044F2 RID: 17650 RVA: 0x0060D404 File Offset: 0x0060B604
		public ShapeFloodFill(int maximumActions = 100)
		{
			this._maximumActions = maximumActions;
		}

		// Token: 0x060044F3 RID: 17651 RVA: 0x0060D414 File Offset: 0x0060B614
		public override bool Perform(Point origin, GenAction action)
		{
			...
			while (queue.Count > 0)
			{
				...
				if (!hashSet.Contains(new Point16(point.X, point.Y)) && base.UnitApply(action, origin, point.X, point.Y, Array.Empty<object>()))
				{
