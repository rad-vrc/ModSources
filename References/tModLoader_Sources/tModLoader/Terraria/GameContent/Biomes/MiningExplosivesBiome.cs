...
namespace Terraria.GameContent.Biomes
{
	...
	{
		// Token: 0x06004705 RID: 18181 RVA: 0x006385D8 File Offset: 0x006367D8
		public unsafe override bool Place(Point origin, StructureMap structures)
		{
			...
			Rectangle area;
			area..ctor(origin.X - 15, origin.Y - 10, 30, 20);
			...
			for (int i = -1; i <= 1; i++)
			{
				WorldUtils.ClearTile(result2.X + i, result2.Y, false);
			...
			WorldGen.PlaceTile(result.X, result.Y, 141, false, false, -1, 0);
