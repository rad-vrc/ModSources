...
namespace Terraria.Map
{
	...
	{
		// Token: 0x06001476 RID: 5238 RVA: 0x004A34BC File Offset: 0x004A16BC
		...
		// Token: 0x0600147C RID: 5244 RVA: 0x004AB124 File Offset: 0x004A9324
		...
		// Token: 0x0600147D RID: 5245 RVA: 0x004AB1B0 File Offset: 0x004A93B0
		public static MapTile CreateMapTile(int i, int j, byte Light)
		{
			...
			if (tile.active())
			{
				int num5 = (int)tile.type;
				num3 = (int)MapHelper.tileLookup[num5];
				...
				else
				{
					...
					if (num3 != 0)
					{
						MapHelper.GetTileBaseOption(i, j, num5, tile, ref num4);
						if (num5 == 160)
						{
							num = 0;
						}
			...
			if (num3 == 0)
			{
				...
				if (tile.liquid > 32)
				{
					int num6 = (int)tile.liquidType();
					num3 = (int)MapHelper.liquidPosition + num6;
				}
			...
			if (num3 == 0)
			{
				if ((double)j < Main.worldSurface)
				{
					...
					{
						int num7 = (int)((byte)(255.0 * ((double)j / Main.worldSurface)));
						num3 = (int)MapHelper.skyPosition + num7;
						num2 = 255;
						num = 0;
					}
				}
				else if (j < Main.UnderworldLayer)
				{
					...
					{
						float num12 = (float)Main.SceneMetrics.SnowTileCount / (float)SceneMetrics.SnowTileMax;
						num12 *= 255f;
						if (num12 > 255f)
						{
							num12 = 255f;
		...
		// Token: 0x0600147E RID: 5246 RVA: 0x004AB564 File Offset: 0x004A9764
			...
			if (tileType <= 242)
			{
				...
				else
				{
					...
					else
					{
						...
						if ((num4 >= 18 && num4 <= 35) || (num4 >= 63 && num4 <= 71) || num4 == 74 || (num4 >= 76 && num4 <= 92))
						{
							baseOption = 1;
							return;
						}
		...
		// Token: 0x0600147F RID: 5247 RVA: 0x004AC410 File Offset: 0x004AA610
		...
		// Token: 0x06001480 RID: 5248 RVA: 0x004AC4CC File Offset: 0x004AA6CC
		...
		// Token: 0x06001481 RID: 5249 RVA: 0x004ACBD4 File Offset: 0x004AADD4
		...
		// Token: 0x06001482 RID: 5250 RVA: 0x004ACFB0 File Offset: 0x004AB1B0
		...
		{
			// Token: 0x0600312C RID: 12588 RVA: 0x005E4D96 File Offset: 0x005E2F96
			public bool active()
			{
				return (this.misc & 1) == 1;
			}

			// Token: 0x0600312D RID: 12589 RVA: 0x005E4DA6 File Offset: 0x005E2FA6
			public bool water()
			{
				return (this.misc & 2) == 2;
			}

			// Token: 0x0600312E RID: 12590 RVA: 0x005E4DB6 File Offset: 0x005E2FB6
			public bool lava()
			{
				return (this.misc & 4) == 4;
			}

			// Token: 0x0600312F RID: 12591 RVA: 0x005E4DC6 File Offset: 0x005E2FC6
			public bool honey()
			{
				return (this.misc2 & 64) == 64;
			}

			// Token: 0x06003130 RID: 12592 RVA: 0x005E4DD8 File Offset: 0x005E2FD8
			public bool changed()
			{
				return (this.misc & 8) == 8;
			}

			// Token: 0x06003131 RID: 12593 RVA: 0x005E4DE8 File Offset: 0x005E2FE8
			public bool wall()
			{
				return (this.misc & 16) == 16;
			}

			// Token: 0x06003132 RID: 12594 RVA: 0x005E4DFC File Offset: 0x005E2FFC
			public byte option()
			{
				byte b = 0;
				if ((this.misc & 32) == 32)
			...
			// Token: 0x06003133 RID: 12595 RVA: 0x005E4E58 File Offset: 0x005E3058
			public byte color()
			{
