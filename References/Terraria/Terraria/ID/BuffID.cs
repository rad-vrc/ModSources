...
namespace Terraria.ID
{
	...
	public class BuffID
	{
		...
		public class Sets
		{
			...
			public static bool[] CanBeRemovedByNetMessage = BuffID.Sets.Factory.CreateBoolSet(new int[]
			{
				313
			});
			...
			public static BuffID.Sets.BuffMountData[] BasicMountData = BuffID.Sets.Factory.CreateCustomSet<BuffID.Sets.BuffMountData>(null, new object[]
			{
				118,
				new BuffID.Sets.BuffMountData
				{
					mountID = 6,
					faceLeft = true
				},
