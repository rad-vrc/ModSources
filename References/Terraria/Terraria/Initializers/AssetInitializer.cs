...
namespace Terraria.Initializers
{
	...
	{
		// Token: 0x0600155C RID: 5468 RVA: 0x004B5B28 File Offset: 0x004B3D28
		...
		// Token: 0x0600155D RID: 5469 RVA: 0x004B5BE4 File Offset: 0x004B3DE4
		...
		// Token: 0x0600155E RID: 5470 RVA: 0x004B5C04 File Offset: 0x004B3E04
		...
		// Token: 0x0600155F RID: 5471 RVA: 0x004B5C22 File Offset: 0x004B3E22
		...
		// Token: 0x06001560 RID: 5472 RVA: 0x004B5C54 File Offset: 0x004B3E54
		...
		// Token: 0x06001561 RID: 5473 RVA: 0x004B5D45 File Offset: 0x004B3F45
		...
		// Token: 0x06001562 RID: 5474 RVA: 0x0003C3EC File Offset: 0x0003A5EC
		public static void Load(bool asyncLoad)
		{
		}

		// Token: 0x06001563 RID: 5475 RVA: 0x004B5D60 File Offset: 0x004B3F60
		...
		// Token: 0x06001564 RID: 5476 RVA: 0x004B5DC1 File Offset: 0x004B3FC1
		private static void LoadSounds(AssetRequestMode mode)
		{
			SoundEngine.Load(Main.instance.Services);
		}

		// Token: 0x06001565 RID: 5477 RVA: 0x004B5DD2 File Offset: 0x004B3FD2
		...
		// Token: 0x06001566 RID: 5478 RVA: 0x004B5E04 File Offset: 0x004B4004
		...
		// Token: 0x06001567 RID: 5479 RVA: 0x004B5E14 File Offset: 0x004B4014
		private static void LoadTextures(AssetRequestMode mode)
		{
			...
			{
				TextureAssets.Pvp[num26] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\PVP_" + num26, mode);
			}
			for (int num27 = 0; num27 < TextureAssets.EquipPage.Length; num27++)
			{
				TextureAssets.EquipPage[num27] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\DisplaySlots_" + num27, mode);
			}
			...
			{
				TextureAssets.CraftToggle[num28] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\Craft_Toggle_" + num28, mode);
			}
			for (int num29 = 0; num29 < TextureAssets.InventorySort.Length; num29++)
			{
				TextureAssets.InventorySort[num29] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\Sort_" + num29, mode);
			}
			for (int num30 = 0; num30 < TextureAssets.TextGlyph.Length; num30++)
			{
				TextureAssets.TextGlyph[num30] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\Glyphs_" + num30, mode);
			}
			for (int num31 = 0; num31 < TextureAssets.HotbarRadial.Length; num31++)
			{
				TextureAssets.HotbarRadial[num31] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\HotbarRadial_" + num31, mode);
			}
			for (int num32 = 0; num32 < TextureAssets.InfoIcon.Length; num32++)
			{
				TextureAssets.InfoIcon[num32] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\InfoIcon_" + num32, mode);
			}
			for (int num33 = 0; num33 < TextureAssets.Reforge.Length; num33++)
			{
				TextureAssets.Reforge[num33] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\Reforge_" + num33, mode);
			}
			for (int num34 = 0; num34 < TextureAssets.Camera.Length; num34++)
			{
				TextureAssets.Camera[num34] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\Camera_" + num34, mode);
			}
			for (int num35 = 0; num35 < TextureAssets.WireUi.Length; num35++)
			{
				TextureAssets.WireUi[num35] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\Wires_" + num35, mode);
			}
			...
			{
				TextureAssets.JellyfishBowl[num36 - 1] = AssetInitializer.LoadAsset<Texture2D>("Images\\jellyfishBowl" + num36, mode);
			}
			...
			{
				TextureAssets.MapBGs[num37] = AssetInitializer.LoadAsset<Texture2D>("Images\\MapBG" + (num37 + 1), mode);
			}
			...
			{
				TextureAssets.GlowMask[num38] = AssetInitializer.LoadAsset<Texture2D>("Images\\Glow_" + num38, mode);
			}
			for (int num39 = 0; num39 < TextureAssets.HighlightMask.Length; num39++)
			{
				if (TileID.Sets.HasOutlines[num39])
				{
					TextureAssets.HighlightMask[num39] = AssetInitializer.LoadAsset<Texture2D>("Images\\Misc\\TileOutlines\\Tiles_" + num39, mode);
				}
			}
			for (int num40 = 0; num40 < (int)ExtrasID.Count; num40++)
			{
				TextureAssets.Extra[num40] = AssetInitializer.LoadAsset<Texture2D>("Images\\Extra_" + num40, mode);
			}
			for (int num41 = 0; num41 < 4; num41++)
			{
				TextureAssets.Coin[num41] = AssetInitializer.LoadAsset<Texture2D>("Images\\Coin_" + num41, mode);
			}
			...
			{
				TextureAssets.XmasTree[num42] = AssetInitializer.LoadAsset<Texture2D>("Images\\Xmas_" + num42, mode);
			}
			for (int num43 = 0; num43 < 6; num43++)
			{
				TextureAssets.Clothes[num43] = AssetInitializer.LoadAsset<Texture2D>("Images\\Clothes_" + num43, mode);
			}
			for (int num44 = 0; num44 < TextureAssets.Flames.Length; num44++)
			{
				TextureAssets.Flames[num44] = AssetInitializer.LoadAsset<Texture2D>("Images\\Flame_" + num44, mode);
			}
			for (int num45 = 0; num45 < 8; num45++)
			{
				TextureAssets.MapIcon[num45] = AssetInitializer.LoadAsset<Texture2D>("Images\\Map_" + num45, mode);
			}
			for (int num46 = 0; num46 < TextureAssets.Underworld.Length; num46++)
			{
				TextureAssets.Underworld[num46] = AssetInitializer.LoadAsset<Texture2D>("Images/Backgrounds/Underworld " + num46, 0);
			}
			...
			{
				TextureAssets.NpcHead[num47] = AssetInitializer.LoadAsset<Texture2D>("Images\\NPC_Head_" + num47, mode);
			}
			for (int num48 = 0; num48 < TextureAssets.NpcHeadBoss.Length; num48++)
			{
				TextureAssets.NpcHeadBoss[num48] = AssetInitializer.LoadAsset<Texture2D>("Images\\NPC_Head_Boss_" + num48, mode);
			}
			for (int num49 = 1; num49 < TextureAssets.BackPack.Length; num49++)
			{
				TextureAssets.BackPack[num49] = AssetInitializer.LoadAsset<Texture2D>("Images\\BackPack_" + num49, mode);
			}
			for (int num50 = 1; num50 < BuffID.Count; num50++)
			{
				TextureAssets.Buff[num50] = AssetInitializer.LoadAsset<Texture2D>("Images\\Buff_" + num50, mode);
			}
			...
			{
				TextureAssets.RudolphMount[num51] = AssetInitializer.LoadAsset<Texture2D>("Images\\Rudolph_" + num51, mode);
			}
			...
			{
				TextureAssets.Gem[num52] = AssetInitializer.LoadAsset<Texture2D>("Images\\Gem_" + num52, mode);
			}
			for (int num53 = 0; num53 < CloudID.Count; num53++)
			{
				TextureAssets.Cloud[num53] = AssetInitializer.LoadAsset<Texture2D>("Images\\Cloud_" + num53, mode);
			}
			for (int num54 = 0; num54 < 4; num54++)
			{
				TextureAssets.Star[num54] = AssetInitializer.LoadAsset<Texture2D>("Images\\Star_" + num54, mode);
			}
			for (int num55 = 0; num55 < 15; num55++)
			{
				TextureAssets.Liquid[num55] = AssetInitializer.LoadAsset<Texture2D>("Images\\Liquid_" + num55, mode);
				TextureAssets.LiquidSlope[num55] = AssetInitializer.LoadAsset<Texture2D>("Images\\LiquidSlope_" + num55, mode);
			}
			...
			{
				TextureAssets.Cursors[num56] = AssetInitializer.LoadAsset<Texture2D>("Images\\UI\\Cursor_" + num56, mode);
			}
			...
			{
				TextureAssets.CageTop[num57] = AssetInitializer.LoadAsset<Texture2D>("Images\\CageTop_" + num57, mode);
			}
			for (int num58 = 0; num58 < TextureAssets.Moon.Length; num58++)
			{
				TextureAssets.Moon[num58] = AssetInitializer.LoadAsset<Texture2D>("Images\\Moon_" + num58, mode);
			}
			for (int num59 = 0; num59 < TextureAssets.TreeTop.Length; num59++)
			{
				TextureAssets.TreeTop[num59] = AssetInitializer.LoadAsset<Texture2D>("Images\\Tree_Tops_" + num59, mode);
			}
			for (int num60 = 0; num60 < TextureAssets.TreeBranch.Length; num60++)
			{
				TextureAssets.TreeBranch[num60] = AssetInitializer.LoadAsset<Texture2D>("Images\\Tree_Branches_" + num60, mode);
			}
			...
			{
				TextureAssets.Chains[num61] = AssetInitializer.LoadAsset<Texture2D>("Images\\Chains_" + num61, mode);
			}
			...
			{
				TextureAssets.GemChain[num62] = AssetInitializer.LoadAsset<Texture2D>("Images\\GemChain_" + num62, mode);
			}
			for (int num63 = 1; num63 < TextureAssets.Golem.Length; num63++)
			{
				TextureAssets.Golem[num63] = AssetInitializer.LoadAsset<Texture2D>("Images\\GolemLights" + num63, mode);
			}
		...
		// Token: 0x06001568 RID: 5480 RVA: 0x004B7AF4 File Offset: 0x004B5CF4
