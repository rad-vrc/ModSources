...
namespace QoLCompendium.Core
{
	...
	{
		// Token: 0x06000BE5 RID: 3045 RVA: 0x0004F4D7 File Offset: 0x0004D6D7
		public static void AddLoadedMod(this bool loaded, ref Mod mod)
		{
			if (loaded && mod != null)
			{
				LoadModSupport.LoadedMods.Add(mod.Name, mod);
				return;
			}
			if (!loaded)
			{
		...
		// Token: 0x06000BE6 RID: 3046 RVA: 0x0004CCBF File Offset: 0x0004AEBF
		public static void LoadTasks()
		{
		}

		// Token: 0x06000BE7 RID: 3047 RVA: 0x0004F4FA File Offset: 0x0004D6FA
		public static void UnloadTasks()
		{
			LoadModSupport.LoadedMods.Clear();
		}

		// Token: 0x06000BE8 RID: 3048 RVA: 0x0004F508 File Offset: 0x0004D708
